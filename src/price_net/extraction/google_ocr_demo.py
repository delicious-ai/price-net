    ...
    for page in document.pages:
        ...
        for block in page.blocks:
            block_info = {
                ...
                "bounding_box": [{"x": v.x, "y": v.y} for v in block.bounding_box.vertices]
            }
            ...
            for paragraph in block.paragraphs:
                paragraph_info = {
                    ...
                    "bounding_box": [{"x": v.x, "y": v.y} for v in paragraph.bounding_box.vertices],
                    "words": []
                }
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Extract text from image using Google Cloud Vision API")
    parser.add_argument("image_path", help="Path to the image file")
    parser.add_argument("--detailed", action="store_true", help="Use detailed document analysis")
