...
def parse_args():
    ...
    parser.add_argument(
        "--dataset-dir", type=str, help="path to dataset (train or val)"
    )
    parser.add_argument(
        "--prompt-path",
        type=str,
...
def upload_to_gcs(
    local_file_path: str, bucket_name: str, destination_blob_path: str
) -> None:
...
def write_and_upload_jsonl(
    contents: list, local_path: Path, bucket_name: str, blob_path: str
) -> None:
